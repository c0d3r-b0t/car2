...
function my_keydown(e){
 ...
 uploadCar2();
    ...
    function car2_left(){
        if(car2_x>=0){
            car2_x= car2_x-10;
            console.log("When a pressed, x="+car2_x+" y =" +car2_y);
            uploadBackground();
            uploadCar1();
            uploadCar2();
        }
    ...
    function car2_right(){
        if(car2_x>=500){
            car2_x= car2_x-10;
            console.log("When d pressed, x="+car2_x+" y =" +car2_y);
            uploadBackground();
            uploadCar1();
            uploadCar2();
        }
    ...
    function car2_up(){
        if(car2_x<=500){
            car2_x= car2_x+10;
            console.log("When w pressed, x="+car2_x+" y =" +car2_y);
            uploadBackground();
            uploadCar1();
            uploadCar2();
        }
    ...
    function car2_down(){
        if(car2_x<=0){
            car2_x= car2_x+10;
            console.log("When s pressed, x="+car2_x+" y =" +car2_y);
            uploadBackground();
            uploadCar1();
            uploadCar2();
        }
